...
--
-- Vært: localhost
-- Genereringstid: 22. 03 2017 kl. 13:01:12
...
--
-- 8, 'Electronic Arts', 'http://www.ea.com'
--
...
ALTER TABLE `videogames`
 ADD PRIMARY KEY (`id`), ADD KEY `platformid` (`platformid`), ADD KEY `publisherid` (`publisherid`);
